...
#ifndef CAMERA_DETECTION_INTERFACES__SRV__DETAIL__DETECT_PIPE__FUNCTIONS_H_
#define CAMERA_DETECTION_INTERFACES__SRV__DETAIL__DETECT_PIPE__FUNCTIONS_H_
...
#include "camera_detection_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "camera_detection_interfaces/srv/detail/detect_pipe__struct.h"

/// Initialize srv/DetectPipe message.
/**
...
/// Create srv/DetectPipe message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * camera_detection_interfaces__srv__DetectPipe_Request__init().
...
/// Destroy srv/DetectPipe message.
/**
 * It calls
 * camera_detection_interfaces__srv__DetectPipe_Request__fini()
...
/// Check for srv/DetectPipe message equality.
/**
...
/// Initialize array of srv/DetectPipe messages.
/**
...
/// Finalize array of srv/DetectPipe messages.
/**
 * It calls
 * camera_detection_interfaces__srv__DetectPipe_Request__fini()
...
/// Create array of srv/DetectPipe messages.
/**
 * It allocates the memory for the array and calls
 * camera_detection_interfaces__srv__DetectPipe_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DetectPipe messages.
/**
 * It calls
 * camera_detection_interfaces__srv__DetectPipe_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DetectPipe message array equality.
/**
...
/// Copy an array of srv/DetectPipe messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * camera_detection_interfaces__srv__DetectPipe_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_detection_interfaces
...
/**
 * It calls
 * camera_detection_interfaces__srv__DetectPipe_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_detection_interfaces
...
/**
 * It allocates the memory for the array and calls
 * camera_detection_interfaces__srv__DetectPipe_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_detection_interfaces
...
/**
 * It calls
 * camera_detection_interfaces__srv__DetectPipe_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAMERA_DETECTION_INTERFACES__SRV__DETAIL__DETECT_PIPE__FUNCTIONS_H_
